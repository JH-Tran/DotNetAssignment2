...
/*            var TestCusomter = new Customer() { FirstName = "Beta", LastName = "Tester", Email = "testBeta@gmail.com", Password = "abc" };
            ...
            var TestScheduling = new ServiceLog() { Mechanic = TestMechanic, Car = TestCar, Task = "Fix Car", CarOdometer = 1000, StartDateTime = DateTime.Today, EndDateTime = DateTime.Parse("30/10/2023 07:22:16") };
