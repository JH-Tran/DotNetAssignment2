...
namespace CarServiceSystem
{
    internal static class Program
    {
        ...
        static public void Main()
        {
            ...
            var TestLog = new ServiceLog() { Mechanic = TestMechanic, Car = TestCar, Task = "Fix Car", CarOdometer = 1000, StartDateTime = DateTime.Today, EndDateTime = DateTime.Today };
            ...
            context.ServiceLogs.Add(TestLog);
